@extends('userside.userside_source.userside_template')
 <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url({{ asset('assits/images/bg-0.jpg') }});">
    
		<h2 class="ltext-105 cl0 txt-center" style="color: rgb(139, 119, 119)">
			Contact us
		</h2>
	</section>	
	<!-- Content page -->
    ...
    <div class="bor8 m-b-20 how-pos4-parent">
        ...
        <img class="how-pos4 pointer-none" src="{{asset('assits/images/icons/icon-email.png')}}" alt="ICON">
    </div>
