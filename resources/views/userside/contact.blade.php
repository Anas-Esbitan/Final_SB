...
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background:rgb(164, 186, 223)">
            ...
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                <form action="{{ route('contact.store') }}" method="POST">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        ...
                        <img class="how-pos4 pointer-none" src="{{ asset('assits/images/icons/icon-email.png') }}"
                            alt="ICON">
                    </div>
